...
public class SendAnimationMethod implements
    ...
    @Override
    public SendAnimationMethod setDirectMessagesTopicId(Integer topicId) {
    ...
    @Override
    public SendAnimationMethod setSuggestedPostParameters(SuggestedPostParameters parameters) {
